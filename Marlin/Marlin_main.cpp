       ...
       if (!_0p_calibration) {
          ...
          switch (probe_points) {
            ...
            default: // 2*7 point calibration matrix
              ...
              if (towers_set) { // 2*7 point tower angle calibration matrix
                t_delta[A_AXIS] = (       -Z2(5) +Z2(9)        -Z2(11) +Z2(3)         +Z2(2) -Z2(6)        +Z2(8) -Z2(12)) * a_factor;
                t_delta[B_AXIS] = ( Z2(1)        -Z2(9) +Z2(7)         -Z2(3) -Z2(10)        +Z2(6) -Z2(4)        +Z2(12)) * a_factor;
                t_delta[C_AXIS] = (-Z2(1) +Z2(5)        -Z2(7) +Z2(11)        +Z2(10) -Z2(2)        +Z2(4) -Z2(8)        ) * a_factor;
              }
              break;
          }
        ...
        if (verbose_level != 1) {
          ...
          if (_7p_calibration && !_7p_half_circle){
            ...
            print_signed_float(PSTR("yxy"), z_at_pt[4]);
            print_signed_float(PSTR("zyz"), z_at_pt[8]);            
            SERIAL_EOL();
          }
        }
        if (verbose_level != 0) {                                    // !dry run
